  ...
  return (
   <>
      ...
      <div className='sliders_div'>
        <div>
          <Sliderproject move={'left'} img1={industrialextractor1} img2={industrialinstallation2} img3={kitchentractor1} img4={metalfracbication2} img5={steelfracbication1} img6={Trusses1} />
        </div>
        <div>
          <Sliderproject move={'right'} img1={industrialextractor2} img2={industrialinstallation3} img3={kitchentractor2} img4={metalfracbication3} img5={steelfracbication3} img6={Trusses3} />
        </div>
      </div>
    </>
  )
